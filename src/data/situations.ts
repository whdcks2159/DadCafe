...
export const SITUATIONS: SituationGuide[] = [
  ...
  {
    slug: 'joryiwon-prep',
    titleKo: '조리원 2주, 아빠가 해야 할 일 총정리',
    summaryKo: '산후조리원에 있는 동안 아빠가 매일, 매주 챙겨야 할 것들',
    emoji: '/icons/ic-calendar.png',
    tag: 'newborn',
    steps: [
      { order: 1, titleKo: '입소 당일 — 짐 정리 및 환경 확인', descriptionKo: '산모 짐(슬리퍼, 수유 브라, 산후 패드, 세면도구, 편한 옷)이 다 왔는지 확인하세요. 병실 온도 조절기 위치, 비상벨 위치, 수유실 위치를 파악해두세요.' },
      { order: 2, titleKo: '1~3일차 — 모유 수유 지원', descriptionKo: '산모가 수유 자세를 잡는 데 도움을 주고, 유축기가 필요하면 바로 구해오세요. 젖양이 부족할 경우 조리원 간호사에게 모유 촉진법을 물어보는 역할을 아빠가 합니다.' },
      { order: 3, titleKo: '3~5일차 — 출생신고 처리', descriptionKo: '출생일로부터 14일 이내에 출생신고를 해야 합니다. 주민센터 방문 or 정부24 온라인 신청. 병원 출생증명서 지참 필수. 처리 후 건강보험 피부양자 등록도 함께 하세요.' },
      { order: 4, titleKo: '1주차 — 집 준비 점검', descriptionKo: '아기 침대 조립, 젖병 소독기 설치, 속싸개·기저귀 재고 확인. 실내 온도 22~24도, 습도 50~60% 유지 가능한지 체크. 아기 목욕 물품(아기 욕조, 베이비 오일, 면봉) 준비.' },
      { order: 5, titleKo: '1주차 — 정부 지원 신청', descriptionKo: '첫만남이용권(바우처 200만원)과 영아수당(월 30만원) 신청은 출생 후 60일 이내입니다. 주민센터 or 복지로(www.bokjiro.go.kr) 온라인 신청 가능. 놓치면 소급이 안 되니 꼭 챙기세요.' },
      { order: 6, titleKo: '2주차 — 퇴소 준비', descriptionKo: '카시트 설치 여부 재확인(병원에서 조리원 이동 때와 달리 이번엔 직접 운전). 퇴소 당일 아기 외출복·속싸개·담요 챙기기. 수유 쿠션, 유축기, 여분 젖병 집에 미리 셋업.' },
      { order: 7, titleKo: '퇴소 당일 — 집 복귀', descriptionKo: '산모가 계단·문턱에서 넘어지지 않도록 먼저 들어가 문 잡아주세요. 첫날은 방문객 최소화. 집 안 주요 동선(침대↔화장실↔수유 자리)에 야간등 미리 달아두면 야간 수유 때 편해요.' },
    ],
    doList: [
      '조리원 비상연락처 핸드폰에 저장해두기',
      '출생신고 + 건강보험 피부양자 등록 + 첫만남이용권 신청 — 3개 세트로',
      '집 실내 온습도계 미리 구비 (아기방 필수)',
      '퇴소 시 카시트 정확히 장착됐는지 재확인',
      '조리원 체류 중 산모에게 매일 한 번 이상 방문 or 영상통화',
    ],
    dontList: [
      '출생신고 14일 넘기기 — 방치 시 과태료 부과',
      '첫만남이용권·영아수당 신청 기한(60일) 놓치기 — 소급 없음',
      '퇴소 후 첫날부터 방문객 잔뜩 부르기',
      '카시트 없이 아기 데려오기 — 법적 의무이자 사고 위험',
      '"조리원이 다 해줘" 믿고 집 준비 미루기',
    ],
  },
  {
