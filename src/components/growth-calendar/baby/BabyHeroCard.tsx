      ...
      <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-3xl p-5 mb-4 border border-green-100">
        ...
        <div className="flex items-start justify-between mb-4">
          <div>
            ...
            {babyName && (
              <div className="text-sm text-slate-500 mt-0.5">{babyName}의 {currentMonth}번째 달</div>
            )}
          </div>
        ...
        {(log?.heightCm || log?.weightKg) ? (
          <div className="bg-white rounded-2xl px-4 py-3 mb-4 flex items-center justify-around">
            <div className="text-center">
              <div className="text-xs text-slate-400 mb-0.5">키</div>
            ...
            <div className="text-center">
              <div className="text-xs text-slate-400 mb-0.5">몸무게</div>
              <div className="text-xl font-black text-slate-900">
        ...
        <div className="bg-white rounded-2xl px-4 py-3 mb-4">
          ...
          <div className="text-sm text-slate-700">{info.developmentTip}</div>
        </div>
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            {info.milestoneHints.map((hint) => (
              <span
                key={hint}
                className="px-2.5 py-1 bg-white border border-slate-200 text-slate-500 rounded-full text-xs"
              >
                {hint}
              </span>
            ))}
